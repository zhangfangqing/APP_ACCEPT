...
public abstract class AMI_CallHandler_asynCall extends Callback_CallHandler_asynCall
{
    public abstract void ice_response(java.util.Map<java.lang.String, byte[]> __ret);
    ...
    public final void response(java.util.Map<java.lang.String, byte[]> __ret)
    {
        ice_response(__ret);
    }
