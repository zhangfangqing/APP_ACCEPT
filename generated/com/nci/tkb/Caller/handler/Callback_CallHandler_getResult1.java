...
public abstract class Callback_CallHandler_getResult1 extends Ice.TwowayCallback
{
    public abstract void response(java.util.Map<java.lang.String, byte[]> rt);
    ...
    public final void __completed(Ice.AsyncResult __result)
    {
        ...
        try
        {
            __proxy.end_getResult1(rt, __result);
        }
